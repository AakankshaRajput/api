			        ...
			        <div class="col-md-offset-3 col-md-6">
			          ...
			          <div class="box box-primary">
			           ...
			           <?php if(!$data==''){ foreach($data as $val){?>
			            <form role="form" action="<?php echo site_url('user/update-balance');?>" method="post">
			              <div class="box-body">
			              	<div class="form-group">
			                  <label for="exampleInputPassword1">Packages </label>
								<input type="text" name="package" class="form-control" id="exampleInputPassword1" placeholder="Category Name" value="<?php echo $customer[0]->category?>">
			                </div>
			                ...
			                <div class="form-group">
			                	<div class="col-md-4">
			                  		...
			                  		<input type="text" onchange="calc(this)"  class="form-control" id="fordrinks_val" placeholder="Food Name" required="Plz filled this field" value="<?php echo $val->drink;?>">
			                 	</div>
			              		<div class="col-md-4">
			                ...
			                <div class="form-group">
			                	<div class="col-md-4">
			                  		...
			                  		<input type="text" onchange="calc1(this)"  class="form-control" id="forfood_val" placeholder="User ID" required="Please filled this field" value="<?php echo $val->food;?>">
			                	</div>
			                	<div class="col-md-4">
			                 ...
			                 <div class="form-group">
			                 	<div class="col-md-4">
			                  		...
			                  		<input type="text" onchange="cal2(this)"  class="form-control" id="forpackages_val" placeholder="Food Discount" required="Please filled this field" value="<?php echo $val->pack;?>">
			                	</div>
			                	<div class="col-md-4">
			                ...
			                <div class="form-group">
			                  <label for="exampleInputPassword1">User Id</label>
								<input type="text" name="instituteId" class="form-control" id="exampleInputPassword1" placeholder="Category Name" value="<?php echo $customer[0]->uid?>">
			            ...
			            <?php } else{ echo '<h2 style="color:red;2">Data Not Found!</h2>';}?>
			          </div>
			          <!-- /.box -->
