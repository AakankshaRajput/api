        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown messages-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="footer"><a href="<?php echo base_url();?>/admin/#">See All Messages</a></li>
            </ul>
          </li>
          ...
          <li class="dropdown notifications-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="footer"><a href="<?php echo base_url();?>/admin/#">View all</a></li>
            </ul>
          </li>
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="<?php echo base_url();?>admin/change_password" class="btn btn-info btn-flat">Profile</a>
                </div>
                <div class="pull-right">
                  <a href="<?php echo base_url();?>login/logout" class="btn btn-info btn-flat">Sign out</a>
                </div>
              </li>
            </ul>
          </li>
